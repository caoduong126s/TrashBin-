"""
Curate Glass (Thủy tinh) Dataset
Works with data/processed/train/glass
Reduce from 1,200 to 700 most diverse images using clustering
"""
...
def curate_glass(input_dir, output_dir, backup_dir, target_count=700):
    """Curate glass dataset using cluster-based sampling"""
    ...
    print("=" * 60)
    print("GLASS CURATION - Cluster-based Sampling")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    INPUT_DIR = project_root / "data/processed/train/glass"
    OUTPUT_DIR = project_root / "yolo-dataset/train/Thủy tinh"
    BACKUP_DIR = project_root / "yolo-dataset/backup/Thủy tinh"
    ...
    print("2. Run: python 03_copy_other_classes.py")
